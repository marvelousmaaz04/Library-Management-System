                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:TextBox class="form-control" placeholder="ID" ID="TextBox2" runat="server"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <asp:TextBox class="form-control" placeholder="Name" ID="TextBox3" runat="server" ReadOnly="True"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <asp:TextBox class="form-control" placeholder="Name" ID="TextBox4" runat="server" ReadOnly="True"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                <asp:TextBox class="form-control" placeholder="Date" ID="TextBox5" runat="server" ReadOnly="False" TextMode="Date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <asp:TextBox class="form-control" placeholder="Date" ID="TextBox6" runat="server" ReadOnly="False" TextMode="Date"></asp:TextBox>
